...
<head>
    ...
    <script src="https://cloud.tinymce.com/stable/tinymce.min.js?apiKey=3nunz2fpgi81i89vhm9fbroe8qiyvjnut3j76mk245mpxsc9"></script>
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{route('admin.subcategories.index')}}">All Subcategories</a>
                            </li>

                            <li>
                                <a href="{{route('admin.subcategories.create')}}">Create Subcategory</a>
                            </li>
